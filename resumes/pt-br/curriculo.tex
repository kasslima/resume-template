...
\section{Resumo}
    Engenheiro de Software com experiência em desenvolvimento Full Stack, atuando na construção e manutenção de aplicações web, APIs, automações de processos e integrações entre sistemas. Trabalho principalmente com Node.js, React, C\#/.NET, PostgreSQL, Python, Azure Functions e ambientes Cloud, participando da implementação, deploy, sustentação em produção e melhoria contínua. Atualmente aprofundo conhecimentos em Go, AWS, arquitetura de software, sistemas distribuídos e soluções escaláveis.

\section{Experiência}
    \cventry{Recurso Digital}{São Paulo, SP}{Desenvolvedor Full Stack Pleno}{Abr 2026 - Atual}
        \begin{itemize}
            \item Desenvolvo, gerencio e evoluo aplicações web atuando em todo o ciclo de desenvolvimento de software.
            \item Defino arquitetura e soluções técnicas para novas funcionalidades, evolução de sistemas e modernização de legados.
            \item Desenvolvimento de APIs, integrações e serviços usando Node.js e C\#/.NET, incluindo Azure Functions.
            \item Automatizei processos de negócio com Python e n8n, reduzindo atividades de aproximadamente 8 horas de execução manual para poucos minutos.
            \item Estruturo pipelines CI/CD para automação de build, testes e deploy.
            \item Modelo e otimizo consultas em PostgreSQL para suporte a aplicações, análises, dashboards e relatórios de tomada de decisão.
        \end{itemize}

    \cventry{Recurso Digital}{São Paulo, SP}{Desenvolvedor Full Stack Junior}{Out 2024 - Abr 2026}
        \begin{itemize}
            \item Desenvolvi e mantive aplicações web atuando no backend e frontend.
            \item Implementei APIs, serviços e integrações entre sistemas com Node.js e C\#/.NET.
            \item Desenvolvi interfaces e funcionalidades usando React e mantive Azure Functions em ambientes Microsoft Azure.
            \item Criei automações e rotinas em Python para otimização de processos internos.
            \item Atuei na sustentação de sistemas em produção, deploys, monitoramento e manutenção de pipelines CI/CD.
        \end{itemize}

    \cventry{Recurso Digital}{São Paulo, SP}{Estagiário em Análise de Dados}{Jul 2023 - Out 2024}
        \begin{itemize}
            \item Desenvolvi soluções de dados, automações de processos e aplicações web para otimização operacional.
            \item Construí processos de ETL para coleta, transformação e carregamento de dados.
            \item Realizei análises com Power BI para geração de insights e acompanhamento de indicadores.
            \item Contribuí com funcionalidades frontend e backend usando React, Node.js, C\#/.NET, PostgreSQL, Azure e Azure Functions.
            \item Usei Git para versionamento e suporte ao ciclo de desenvolvimento.
        \end{itemize}

    \cventry{Foundever}{São Paulo, Brasil}{Analista de Suporte Jr}{Jun 2022 - Jul 2023}
        \begin{itemize}
            \item Prestei suporte técnico, realizando troubleshooting de hardware e software em ambientes de clientes.
            \item Gerenciei chamados por canais digitais, mantendo comunicação clara com clientes e acompanhamento de incidentes.
            \item Usei Salesforce e Sprinklr para registro, acompanhamento e resolução de casos.
            \item Monitorei indicadores de atendimento e desempenho usando Microsoft Excel.
            \item Colaborei com equipes técnicas para escalonamento e resolução de incidentes complexos.
        \end{itemize}
